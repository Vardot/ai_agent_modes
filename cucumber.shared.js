// Shared cucumber-js worldParameters for the AI Agent Modes suite.
//
// `cucumber.js` imports this and layers its own report / screenshot / video
// paths on top, mirroring the sibling AI Figma suites so a second flavour can
// be added later without artefacts colliding.
...
module.exports = {
  ...
  // tests/step-definitions/ai_agent_modes.steps.js), which iterates this
  // registry and skips entries flagged `isAdmin: true`. Override the admin
